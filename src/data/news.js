...
const NEWS_RANDOM = [
  ...
  'Anonymous donor funds 10,000 protest kits shipped to 40 countries',
  ...
  'Kill Switch stickers spotted on laptops at a major AI safety conference',
  'Former government AI advisor resigns and joins the movement publicly',
  'Middle schoolers write a Kill Switch anthem. 4M streams and counting.',
  'Tech influencer loses half their following after dismissing AI concerns',
  ...
  '"My grandmother asked what AI is, then signed the petition." — activist',
  ...
  'High school walkouts in 12 countries, demanding mandatory AI education reform',
